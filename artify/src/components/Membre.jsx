  ...
  return (
    <div className="app-membre">
      ...
      <div className="membre-section">
        ...
        <div className="gallery-membre">
          <img src="../assets/tete1.jpg" alt="Anatomie de la tête" onClick={() => {
            setModalImage("../assets/tete1.jpg");
            setModalText("Référence de visage humain au regard droit.");

          }} />
          <img src="../assets/tete2.jpg" alt="Vue latérale de la tête" onClick={() => {
            setModalImage("../assets/tete2.jpg");
            setModalText("Référence de visage humain au regard vers le bas.");
          }} />
          <img src="../assets/tete3.jpg" alt="Anatomie de la tête" onClick={() => {
            setModalImage("../assets/tete3.jpg");
            setModalText("Visage d'homme vu de trois-quarts, regardant vers le haut, avec des détails sur les sourcils, les yeux, le nez et la bouche.");

          }} />
          <img src="../assets/tete4.jpg" alt="Vue latérale de la tête" onClick={() => {
            setModalImage("../assets/tete4.jpg");
            setModalText("Femme avec le visage de trois quarts, regardant vers nous, avec des détails sur les sourcils, les yeux, le nez et la bouche.");

          }} />
          <img src="../assets/tete5.jpg" alt="Anatomie de la tête" onClick={() => {
            setModalImage("../assets/tete5.jpg");
            setModalText("Visage de Onizuka vu de face avec les yeux fermés et une grimace emblématique.");
      ...
      <div className="membre-section">
        ...
        <div className="gallery-membre">
          <img src="../assets/bras1.jpg" alt="Anatomie du bras" onClick={() => {
            setModalImage("../assets/bras1.jpg");
            setModalText("Bras en flexion avec mise en évidence du biceps, vue de profil.");

          }} />
          <img src="../assets/bras2.jpg" alt="Vue des muscles du bras" onClick={() => {
            setModalImage("../assets/bras2.jpg");
            setModalText("Bras vu de l'arrière et légèrement de profil, mettant en évidence les triceps.");

          }} />
          <img src="../assets/bras3.jpg" alt="Vue des muscles du bras" onClick={() => {
            setModalImage("../assets/bras3.jpg");
            setModalText("Bras vu principalement de profil, légèrement tourné vers l'arrière, avec une flexion du coude et du poignet, mettant en évidence les muscles de l'avant-bras.");
        ...
        <div className="gallery-membre">
          <img src="../assets/main1.jpg" alt="Anatomie de la main" onClick={() => {
            setModalImage("../assets/main1.jpg");
            setModalText("Représentation d'une main gauche vue de profil, dans une position naturelle, avec le pouce et l'index levés vers le haut. Les autres doigts sont légèrement repliés et détendus, donnant à la main une posture décontractée et naturelle.");
          }} />
          <img src="../assets/main2.jpg" alt="Vue des muscles de la main" onClick={() => {
            setModalImage("../assets/main2.jpg");
            setModalText("Représentation d'une main gauche, serrée, vue légèrement de profil et du dessus.");
          }} />
          <img src="../assets/main3.jpg" alt="Anatomie de la main" onClick={() => {
            setModalImage("../assets/main3.jpg");
            setModalText("Représentation d'une main droite en supination, avec une légère flexion du poignet vers le bas, vue de face.");
          }} />
          <img src="../assets/main4.jpg" alt="Vue des muscles de la main" onClick={() => {
            setModalImage("../assets/main4.jpg");
            setModalText("Représentation d'une main droite, vue de face en pronation, avec l'index légèrement levé et le poignet fléchi vers le bas.");
          }} />
        </div>
      </div>
      ...
      <div className="membre-section">
        ...
        <h4>3.4 Les Pieds</h4>
        <p>
          Les pieds sont formés de 26 os et jouent un rôle crucial dans l’équilibre et la locomotion.
        </p>
        <div className="gallery-membre">
          <img src="../assets/pied1.jpg" alt="Anatomie du pied" onClick={() => {
            setModalImage("../assets/pied1.jpg");
            setModalText("Pied droit, vu de profil et légèrement de face.");
          }} />
          <img src="../assets/pied2.jpg" alt="Vue des os du pied" onClick={() => {
            setModalImage("../assets/pied2.jpg");
            setModalText("Pied gauche vue de face. ");
          }} />
          <img src="../assets/pied3.jpg" alt="Vue des os du pied" onClick={() => {
            setModalImage("../assets/pied3.jpg");
            setModalText("Pied gauche avec orteils relevés.");
          }} />
        </div>
      </div>
      ...
      <div className="membre-section">
        ...
        <div className="gallery-membre">
          <img src="../assets/torse1.jpg" alt="Anatomie du torse" onClick={() => {
            setModalImage("../assets/torse1.jpg");
            setModalText("Vue frontale du torse, mettant en évidence les côtes, les muscles intercostaux.");
          }} />
        </div>
      </div>
      ...
      <div className="membre-section">
        ...
        <div className="gallery-membre">
          {/* Tu peux ajouter des images ici plus tard si besoin */}
        </div>
      </div>
